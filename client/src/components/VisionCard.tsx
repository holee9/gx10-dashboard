    ...
    <div className="card">
      ...
      {loading ? (
        ...
        <div className="text-center py-6 text-gray-400">
          ...
          <p className="text-white text-sm">Vision Brain on Standby</p>
          <p className="text-xs mt-1">Switch to Vision mode to activate</p>
        </div>
      ) : (
        <>
          {/* Container Info */}
          <div className="mb-3 space-y-1.5">
            ...
            {visionStatus?.uptime && (
              <div className="flex items-center justify-between">
                ...
                <span className="text-gx-green text-xs">{visionStatus.uptime}</span>
              </div>
            )}
            ...
            {visionStatus?.memory_usage && (
              <div className="flex items-center justify-between">
                ...
                <span className="text-white text-xs">{visionStatus.memory_usage}</span>
              </div>
            )}
          </div>
          ...
          {/* Vision Models */}
          <div>
            <div className="text-xs text-gray-400 mb-1">Vision Models</div>
